...
function buildBusinessDetailCard (data) {
    ...
    if (data['more_info_link']) {
        ...
        row4.appendChild(rowCol7);
        cardContent.appendChild(row4);
    }
